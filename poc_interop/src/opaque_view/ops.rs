...
#[cfg(test)]
pub mod tests {
    use crate::rust_view::ffi::{create_view_i32, create_view_f64};
    ...
    pub fn create_opaque_view_test() {
        ...
        let opaque_view = create_view_i32(dims, MemSpace::DeviceSpace.into(), Layout::LayoutRight.into(), &mut data);
    ...
    pub fn simple_kernel_opaque_view_test() {
        ...
        let y = create_view_f64( dims1,MemSpace::HostSpace.into(), Layout::LayoutRight.into(), &mut data1);
        let a = create_view_f64( dims2,MemSpace::HostSpace.into(), Layout::LayoutRight.into(), &mut data2);
        let x = create_view_f64( dims3,MemSpace::HostSpace.into(), Layout::LayoutRight.into(), &mut data3);
