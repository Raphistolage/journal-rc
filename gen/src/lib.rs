...
"
                ...
                for config in configs.into_iter() {
                    ...
                    let fn_create_mirror_view_hth_ident =
                        format_ident!("create_mirror_view_hth_{}", raw_extension);
                    let fn_create_mirror_view_dth_ident =
                        format_ident!("create_mirror_view_dth_{}", raw_extension);
                    let fn_create_mirror_view_htd_ident =
                        format_ident!("create_mirror_view_htd_{}", raw_extension);
                    let fn_create_mirror_view_dtd_ident =
                        format_ident!("create_mirror_view_dtd_{}", raw_extension);
                    let fn_create_mirror_view_and_copy_hth_ident =
                        format_ident!("create_mirror_view_and_copy_hth_{}", raw_extension);
                    let fn_create_mirror_view_and_copy_dth_ident =
                        format_ident!("create_mirror_view_and_copy_dth_{}", raw_extension);
                    let fn_create_mirror_view_and_copy_htd_ident =
                        format_ident!("create_mirror_view_and_copy_htd_{}", raw_extension);
                    let fn_create_mirror_view_and_copy_dtd_ident =
                        format_ident!("create_mirror_view_and_copy_dtd_{}", raw_extension);
