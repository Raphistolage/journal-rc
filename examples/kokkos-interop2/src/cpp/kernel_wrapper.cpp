    ...
    namespace kernels {
        ...
        RustViewWrapper create_view(MemSpace memSpace, rust::String label, uint8_t rank, std::array<uint32_t, 7> dimensions) {
            ...
            if (memSpace == MemSpace::HostSpace) {
                ...
                switch(rank) {
                    case 1:
                        view = std::make_unique<ViewHolder<Kokkos::View<double*, Kokkos::LayoutLeft, Kokkos::HostSpace>>>(
                ...
                switch(rank) {
                    case 1:
                        view = std::make_unique<ViewHolder<Kokkos::View<double*, Kokkos::LayoutLeft, Kokkos::DefaultExecutionSpace>>>(
                            std::string(label), dimensions[0]);
                        break;
                    case 2:
                        view = std::make_unique<ViewHolder<Kokkos::View<double**, Kokkos::LayoutLeft, Kokkos::DefaultExecutionSpace>>>(
