fn main() {
    ...
    println!("cargo:rustc-link-search=/home/clissonr/Documents/StageCEA/cmake_rust/build");
    println!("cargo:rustc-link-lib=cxxKokkoslib");
    println!("cargo:rustc-link-arg=-Wl,-rpath,/home/clissonr/Documents/StageCEA/cmake_rust/build");
